...
public class BulletBehaviour : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.gameObject.CompareTag("Player") == false) {
            ...
            if (other.gameObject.CompareTag("Coin") == false && other.gameObject.CompareTag("Fruit") == false && other.gameObject.CompareTag("Gem") == false && other.gameObject.CompareTag("EnemyBullet") == false) {
